...
import com.example.yazon.weather.Adapters.WeatherConverter;
...
public class InformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textPressure.setText(String.format("%.0f", weather.main.pressure) + "in");
        ...
        WeatherApplication.getApiManager().forecast(weather.name).enqueue(new Callback<Forecast>() {
            ...
            public void onResponse(Call<Forecast> call, Response<Forecast> response) {
                ...
                rootLayout.setBackgroundResource(BackgroundUtil.getBackgroundByDate(listForThreeHours.get(0).dt));
